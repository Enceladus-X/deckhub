...
3. 검수를 실행합니다.
4. 검수 요약의 `요약 MD 복사`로 전체 구조 문제를 AI에게 전달할 수 있습니다.
5. 자동 검출 목록을 10개씩 보며 각 카드 아래의 사유 버튼을 누릅니다.
6. 선택한 문항은 즉시 복사 대기로 이동합니다.
7. `ANKI_REVIEW_FIX_REQUEST`, TSV, JSON 리포트 중 필요한 형식으로 저장하거나 복사합니다.
